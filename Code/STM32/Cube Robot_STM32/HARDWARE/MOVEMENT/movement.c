...
static const u16 original_position[4]={1400,1400,1400,1400};          /*初始位置1,2,3,4号舵机的角度*/ 
static const u16 clockwise90_position[4]={430,480,450,45 0};           /*由初始位置顺时针转动90度时1,2,3,4号舵机的角度*/
static const u16 anticlockwise90_position[4]={2400,2400,2400,2400};   /*由初始位置逆时针转动90度时1,2,3,4号舵机的角度*/

static const u16 clockwise180_position[4]={2270,2310,2340,2340};    

static const u16 wrasp_position[4]={2020,1680,1680,1700};             /*机械手抓紧魔方时5,6,7,8号舵机的角度*/
static const u16 loosen_position[4]={1400,1050,1060,1070};            /*机械手松开魔方时5,6,7,8号舵机的角度*/
