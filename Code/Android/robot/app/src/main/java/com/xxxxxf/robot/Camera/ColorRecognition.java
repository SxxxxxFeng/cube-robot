package com.xxxxxf.robot.Camera;
...
*/
    ...
    //4
    //x轴 原{546,636,737,828,924} 改{546,640,735,829,924};
    /*private static final int color_x_position[]={544,639,734,829,924};
    //y轴 原{207,298,385,472,560}; 改{196,290,385,479,574};
    private static final int color_y_position[]={194,289,384,479,574};*/

    /*private static final int color_x_position[]={546,640,735,829,924};
    private static final int color_y_position[]={194,289,384,479,574};*/

    private static final int color_x_position[]={550,660,770,880,990};
    private static final int color_y_position[]={150,260,370,480,590};

    public int[] getColor_x_position(){
        return color_x_position;
    }
    public int[] getColor_y_position(){
        return color_y_position;
    }
   /*
   //2号
