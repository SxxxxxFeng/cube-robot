...
import com.xxxxxf.robot.MainActivity;
...
public class BluetoothChatService {
    ...
    public static final int STATE_CONNECTING = 2; // 监听传出连接
    public static final int STATE_CONNECTED = 3;  // 连接设备
